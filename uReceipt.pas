    ...
    begin
      ...
      try
        ...
        try
          ...
          DrawText(Printer.Canvas.Handle, 
            PChar(UTF8ToString('توقيع المستلم: _________________')), -1, 
            TextRect, DT_RIGHT or DT_RTLREADING);
          ...
          DrawText(Printer.Canvas.Handle, 
            PChar(UTF8ToString('توقيع أمين المخزن: _________________')), -1, 
            TextRect, DT_RIGHT or DT_RTLREADING);
          
          // طباعة ختم في أسفل الصفحة
          Y := Y + LineHeight * 4;
          ...
          DrawText(Printer.Canvas.Handle, 
            PChar(UTF8ToString('الجيش المصري - نظام إدارة المخازن')), -1, 
            TextRect, DT_CENTER);
